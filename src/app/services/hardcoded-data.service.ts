  ...
  getAllAccounts(): Account[] {
    const allAccounts: Account[] = [
      ...
      },
      {
        name: 'Treas-0927',
        id: 'IBI-ACCT-3',
        percentFromAllFirmAccounts: 18.51,
        actualValueAccountTotal: 0,
        type: 'Bond',
        comment: 'Treasury 4.125 30 Sep 2027',
        unitAmount: 0,
        currency: 'YAR',
        unitValue: 1,
      ...
      ////   MEITAV
      {
        name: 'Cashflow internal',
        id: 'MTV-ACCT-1',
        percentFromAllFirmAccounts: 43.81,
        actualValueAccountTotal: 0,
        type: 'Cash',
        comment: 'For internal firm cashflow',
        unitAmount: 0,
      ...
      },
      {
        name: 'GovIL-0526',
        id: 'MTV-ACCT-2',
        percentFromAllFirmAccounts: 11.9,
        actualValueAccountTotal: 0,
        type: 'bond',
      ...
      },
      {
        name: 'ETF T3 Month',
        id: 'MTV-ACCT-3',
        percentFromAllFirmAccounts: 44.29,
        actualValueAccountTotal: 0,
        type: 'ETF',
        comment: 'Resets every 3 months',
        unitAmount: 0,
